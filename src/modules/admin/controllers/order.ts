...
export class OrderController {
  ...
  @Delete(':orderId')
  public async delete(@Param('orderId', ParseIntPipe) orderId: number, @CurrentUser() currentOrder: ICurrentUser) {
    return this.orderService.remove(orderId, currentOrder);
  }
